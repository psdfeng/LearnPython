...
class Column(models.Model):
    ...
    class Meta:
        verbose_name = 'column'
        verbose_name_plural = 'colum'
        ordering = ['name']


class ArticleManager(models.Manager):
    def query_by_colunm(self, colum_id):
        query = self.get_queryset().filter(colum_id=colum_id)
...
class Article(models.Model):
    column = models.ForeignKey(Column, blank=True, null=True, verbose_name='belong to', on_delete=models.PROTECT)
    ...
    published = models.BooleanField('notDragt', default=True)
...
class Comment(models.Model):
    user = models.ForeignKey('NewUser', null=True, on_delete=models.PROTECT)
